...
__all__ = ["COCODenseDVOCNewBaselineDatasetMapper"]
...
def build_transform_gen(cfg, is_train, no_crop=False):
    ...
    # Prevent cropping to make sure no annotations are lost
    if no_crop:
        print("\n\n no crop for tuning \n\n")
        max_scale = 1.0
...
class COCODenseDVOCNewBaselineDatasetMapper:
    """
    ...
    def __init__(
        ...
        *,
        ...
        logging.getLogger(__name__).info(
            "[COCODenseDVOCNewBaselineDatasetMapper] Full TransformGens used in training: {}".format(str(self.tfm_gens))
        )
    ...
    def __call__(self, dataset_dict):
        ...
        dataset_dict["file_name"] = dataset_dict["file_name"]
        ...
        if "annotations" in dataset_dict:
            ...
            captions = Captions([obj["caption"] for obj in annos])
