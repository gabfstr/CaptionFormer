...
#   from https://github.com/fanghaook/OVFormer/blob/main/ovformer/modeling/pixel_decoder/msdeformattn.py
import logging
import numpy as np
...
class MSDeformAttnPixelDecoder(nn.Module):
    ...
    def from_config(cls, cfg, input_shape: Dict[str, ShapeSpec]):
        ...
        ret["box_only"] = cfg.MODEL.MASK_FORMER.BOX_ONLY
        return ret
    ...
    def forward_features(self, features):
        ...
        if self.box_only:
            return None, out[0], multi_scale_features
