...
#   from https://github.com/fanghaook/OVFormer/blob/main/tools/convert-thirdparty-pretrained-model-to-d2.py
import argparse
import pickle 
import torch
...
download swin_base_patch4_window12_384_22k.pth from https://github.com/microsoft/Swin-Transformer
python ../tools/convert-thirdparty-pretrained-model-to-d2.py --path swin_base_patch4_window12_384_22k.pth
