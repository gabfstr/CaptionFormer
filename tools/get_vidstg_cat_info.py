...
if __name__ == '__main__':
    ...
    parser.add_argument("--ann", default='datasets/VidSTG/annotations/train_instances_.json')
    ...
    out_path = 'datasets/metadata/vidstg_train_cat_info.json'
    # out_path = 'datasets/metadata/bensmot_train_cat_info.json'
