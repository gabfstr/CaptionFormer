...
#   from https://github.com/fanghaook/OVFormer/blob/main/tools/get_lvis_cat_info.py
import argparse
import json
...
if __name__ == '__main__':
    ...
    parser.add_argument("--out_file", default='datasets/metadata/lvis_v1_train_cat_info.json')
