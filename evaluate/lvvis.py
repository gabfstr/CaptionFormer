...
#   from https://github.com/fanghaook/OVFormer/blob/main/evaluate/lvvis.py
...
class LVVIS:
    def __init__(self, annotation_file=None):
        ...
        if not annotation_file == None:
            ...
            self.createIndex()
            self.base_categories = [i['id'] for i in dataset['categories'] if i['partition'] in [0,1]]
            self.novel_categories = [i['id'] for i in dataset['categories'] if i['partition'] in [2,3]]
