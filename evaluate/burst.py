...
#   from https://github.com/fanghaook/OVFormer/blob/main/evaluate/burst.py
...
class BURST:
    def __init__(self, annotation_file=None):
        ...
        if not annotation_file == None:
            ...
            self.base_categories = [i['id'] for i in dataset['categories'] if i['frequency'] in ['c','f']]
            self.novel_categories = [i['id'] for i in dataset['categories'] if i['frequency'] in ['r']]
            self.common_categories = [i['id'] for i in dataset['categories'] if i['split'] in ['common']]
            self.uncommon_categories = [i['id'] for i in dataset['categories'] if i['split'] in ['uncommon']]
