...
#   from https://github.com/fanghaook/OVFormer/blob/main/train_net_video.py
"""
...
class Trainer(DefaultTrainer):
    ...
    def build_evaluator(cls, cfg, dataset_name, output_folder=None):
        ...
        elif "burst" in dataset_name:
            return BURSTEvaluator(dataset_name, cfg, True, output_folder)
        else:
